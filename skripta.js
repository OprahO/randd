...
console.log("Leaked DDOS SCRIPT".rainbow);
console.log("\x1b[36m target\x1b[37m %s | " + "\x1b[35m" + parsed.host + "\x1b[37m", process.argv[2]);
console.log("Target submission successful, this pressure test time is %s seconds", process.argv[4]);
